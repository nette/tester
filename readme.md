...
Nette Tester 2.6 is compatible with PHP 8.1 to 8.5. Collecting and processing code coverage information depends on Xdebug or PCOV extension, or PHPDBG SAPI.
